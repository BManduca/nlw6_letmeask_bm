...
//webpack -> Module Bundler, basicamente pega a extensão do arquivo 
// e ter algumas configurações pré-determinadas para cada tipo de 
// arquivo ser entendido nas importações do JS
...
export function Home() {
  ...
  async function handleJoinRoom(event: FormEvent) {
    ...
    if (!roomRef.exists()) {
      //alert("A sala requisitada, não existe!");
      toast.error("A sala requisitada, não existe!");
      return;
    }

    if (roomRef.val().closedAt) {
      //alert("A sala requisitada, foi encerrada!");
      toast("A sala requisitada, foi encerrada!", 
        {
          icon: '☑️',
          style: {
            borderRadius: '7px',
      ...
      <main>
        <div className="main-content">
          {theme === 'light' ? (
            ...
            <img src={logoImgWhite} alt="Letmeask" />
          )}
          {!user ? (
