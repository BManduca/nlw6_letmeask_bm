...
export function Room() {
  ...
  //generics -> parâmetro passado para tipagem
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    if(!user) {
      toast.error("É necessário estar autenticado para prosseguir.")
  ...
  async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
    if (likeId) {
      ...
      .push({
        //tentar acessar com id do user, caso o usuário correspondente exista
        authorId: user?.id,
      })
    }
  }
